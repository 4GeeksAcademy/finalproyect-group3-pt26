                ...
                !adminUser ? (
                    ...
                    <div>
                        ...
                        <div className="d-flex flex-row justify-content-center mt-3">
                            <Link to="/user" className="card text-white bg-primary mb-3" style={{ maxWidth: "18rem", marginRight: "1rem" }}>
                            ...
                            <Link to="/booking" className="card text-white bg-secondary mb-3 " style={{ maxWidth: "18rem", marginRight: "1rem" }}>
                            ...
                            <Link to="/add-tours" className="card text-white bg-success mb-3" style={{ maxWidth: "18rem", marginRight: "1rem" }}>
                            ...
                            <Link to="/add-hotel" className="card text-white bg-danger mb-3 mr-1rem" style={{ maxWidth: "18rem", marginRight: "1rem" }}>
                            ...
                            <Link to="/add-packages" className="card text-white bg-info mb-3 mr-1rem" style={{ maxWidth: "18rem", marginRight: "1rem" }}>
