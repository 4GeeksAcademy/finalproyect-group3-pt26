                ...
                <div className="container">
                    <div className="row">
                        ...
                        <div className="col-sm-10">
                            <input
                                style={{ borderRadius: "22px" }} className="form-control form-control-lg colorStyle" placeholder="Email"
                                type="email"
                                value={user.email || ""}
                    ...
                    <div className="row">
                        ...
                        <div className="col-sm-10">
                            <input
                                style={{ borderRadius: "22px" }} className="form-control form-control-lg colorStyle" placeholder="Password"
                                type="password"
                                value={user.password || ""}
